...
# If it doesn’t exist, add it to the dictionary as the key and with the given count as value.
    ...
    def add_animal(self, animal_type, count = 1):
            ...
            if animal_type in self.animals:
                self.animals[animal_type] = int(count) + 1
            else:
...
# Step 4: Implement the get_info Method
    def get_info(self):
        ...
        info.append(" ")
        info.append("     E-I-E-I-0")
        return "\n".join(info)

        # print(f"{self.name}'s Farm")
        # print()
        # for key, value in self.animals:
        #       print(f"{key}: {value}")
        # print()
        # print("     E-I-E-I-0")
...
macdonald.add_animal('duck', 4)
macdonald.add_animal('horse')
print(macdonald.get_info())
print(f'Sorted list of animals: {macdonald.get_animal_types()}')
